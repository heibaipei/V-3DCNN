...
# result output
result_dir = "/home/hy01/emotion_first/result/3D_CNN/"
###########################################################################
# build network
###########################################################################
...
#	print("test_accuracy:",test_accuracy)
	...
	writer = pd.ExcelWriter(result_dir+subject+"_"+arousal_or_valence+".xlsx")
	...
	sio.savemat(arousal_or_valence+"_"+subject+"3D_model.mat",model_dict)
	'''
